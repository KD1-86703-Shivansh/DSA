...
public class BST {
	...
	private Node recursionSearch(Node trav, int key) {
		if (trav == null)
			return null;
		if (key == trav.data)
			return trav;
		else if (key < trav.data)
			return recursionSearch(trav.left, key);
		else
			return recursionSearch(trav.right, key);
	}
	
	public Node recursionSearch(int key) {
